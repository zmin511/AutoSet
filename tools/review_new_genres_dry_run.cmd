...
"%PY%" -B "%SCRIPT%" "%TARGET%" --db-path "G:\Engine Library\Database2\m.db" --music-root "G:\Music" --report-dir "G:\zmin_autoset\reports\genres" --backup-dir "G:\zmin_autoset\tag_backups"
pause
